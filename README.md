...
| **tagErrorMessage** | `string` | `null` | Tag error message to display in dropdown while creating new tag if number of tags exceeds the `max` limit when using `tags` mode. |
...
<Multiselect ... :classes="{
  ...
  tagError: 'text-red-500 text-sm whitespace-nowrap',
